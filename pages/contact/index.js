          ...
          >
            <div className='flex-1 flex flex-col gap-y-4 xl:gap-y-8 mb-12 xl:mb-0'>
              <div className='flex items-center gap-x-4'>
                <div className='text-2xl text-accent'><FaEnvelope /></div>
                <div>adnanayaz479@gmail.com</div>
              </div>
              <div className='flex items-center gap-x-4'>
                <div className='text-2xl text-accent'><FaPhone /></div>
              ...
              <div className='flex items-center gap-x-4'>
                <div className='text-2xl text-accent'><FaLinkedin /></div>
                <div>linkedin.com/in/Adnan-Ayaz-Awan</div>
              </div>
              <div className='flex items-center gap-x-4'>
                <div className='text-2xl text-accent'><FaGithub /></div>
            ...
            <form onSubmit={handleSubmit} className='flex-1 flex flex-col gap-y-4'>
              <div className='flex flex-col sm:flex-row gap-y-4 sm:gap-x-4'>
                <input type='text' name='name' value={formData.name} onChange={handleChange} placeholder='Name' className={`input ${errors.name ? 'border-red-500' : ''}`} />
                <input type='email' name='email' value={formData.email} onChange={handleChange} placeholder='Email' className={`input ${errors.email ? 'border-red-500' : ''}`} />
              </div>
              <input type='text' name='subject' value={formData.subject} onChange={handleChange} placeholder='Subject' className='input' />
              <textarea name='message' value={formData.message} onChange={handleChange} placeholder='Message' className={`textarea ${errors.message ? 'border-red-500' : ''}`}></textarea>
