const ATSResume = ({ resumeRef }) => {
  return (
    ...
    >
      {/* Header */}
      <header style={{ textAlign: 'center', marginBottom: '18px', paddingBottom: '14px', borderBottom: '2.5px solid #000000' }}>
...
const SkillLabel = ({ text }) => (
  <div style={{ fontWeight: 700, color: '#000000', fontSize: '11.5px', paddingTop: '1px' }}>{text}</div>
);
