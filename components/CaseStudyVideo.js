      ...
      {src ? (
        <>
          ...
          <button
            ...
            className='absolute bottom-3 right-3 w-10 h-10 rounded-full bg-black/60 hover:bg-accent text-white flex items-center justify-center text-lg transition-all duration-300 opacity-0 group-hover:opacity-100'
          >
